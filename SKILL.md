...
1. **默认不推泛励志、成功学、鸡血效率、浅层商业增长术和管理鸡汤**。不要把人的内在冲突翻译成"更努力、更高效、更会赚钱"。但不排除商业、经济学、组织学和管理学本身：如果当天隐性议题确实是商业结构、组织判断、产品策略、激励机制、定价或商业模式，可以推经济学、组织理论、管理学经典或扎实商业研究。
...
- 它通常是认知/关系/自我层面的卡点；如果是商业问题，必须是具体的结构性问题（产品、组织、定价、激励、商业模式），而不是"我还不够努力/高效/会增长"
...
- 默认排除：泛成功学、鸡血效率、浅层增长术、个人变现套路、管理鸡汤、把复杂问题简化成"执行力/心态/财富密码"的书
- 不默认排除：商业、经济学、组织学、管理学。只有当当天议题本身是产品、组织、定价、激励、商业模式等结构性问题时，才从这些学科里选扎实的书
- 默认优先：经典心理学 / 哲学 / 思想家原著 / 社科 / 文学；结构性商业议题优先经济学 / 组织理论 / 管理学经典 / 高质量商业研究
